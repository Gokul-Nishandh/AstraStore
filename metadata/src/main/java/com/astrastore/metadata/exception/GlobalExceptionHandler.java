...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleDuplicateBucket(DuplicateBucketException ex) {
    ...
    public ResponseEntity<ErrorResponse> handleGeneric(Exception ex) {
        log.error("Unhandled exception in metadata service", ex);
        return buildResponse("INTERNAL_ERROR", ex.getMessage() != null ? ex.getMessage() : "Internal server error", HttpStatus.INTERNAL_SERVER_ERROR);
    }
